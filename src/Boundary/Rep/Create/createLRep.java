 ...
 */
public class createLRep extends javax.swing.JInternalFrame {
    ...
    public createLRep() {
        initComponents();
        lblLRepID.setText(Controller.Rep.createManager.getNextID(EAuth.Location_Representative));
        Date today = new Date();
    ...
    private void initComponents() {
        ...
        lblLRepID = new javax.swing.JLabel();
        ...
        jLabel1.setText("Please use the form below to create a new Location Representative");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(20, 11, 490, 16);

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("LRep ID");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(20, 50, 80, 14);

        lblLRepID.setForeground(new java.awt.Color(255, 255, 255));
        lblLRepID.setText("jLabel3");
        getContentPane().add(lblLRepID);
        lblLRepID.setBounds(110, 50, 150, 16);
        ...
        jButton1.setText("Create Location Representative");
        ...
        jButton1.setBounds(20, 280, 240, 30);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(!errFirstName.getIcon().equals(vIcon.getIcon()) ||
            ...
            iMuzaMusic.Success("LRep #"+lblLRepID.getText()+" has been successfully created.");
            LRep a = new LRep(fldPhone.getText(), fldEmail.getText(), jxBirthDate.getDate(), lblLRepID.getText(), fldFirstName.getText(), fldLastName.getText(), fldPassword.getText(), EAuth.Agent);
    ...
    private javax.swing.JLabel lblLRepID;
